jQuery(document).ready(function($) {
    ...
    if (typeof jQuery.ui != 'undefined') {
        ...
        $(function () {
            ...
            }).on('click', '.ui-datepicker-prev', handlePrevClicks)
              .on('click', '.ui-datepicker-next', handleNextClicks);
            ...
            $(".btn-datepicker").on('click', function() {
                ...
                datepickerDiv.data('picker', this);
            ...
            $.datepicker.setDefaults({
                ...
                onClose: function () {
                    ...
                    $nextObj = $(this).closest('li').next().find('input, button');
                    if ($nextObj[0].tagName == 'INPUT') {
                        $nextObj.focus().click();
                    } else {
                        $nextObj.focus();
                    }
            ...
            $(document).on('keydown', '#ui-datepicker-div', function calendarKeyboardListener(keyVent) {
                var container = this;
        ...
        function getMonthFullName(month)
        {
            ...
            if (typeof mapping[month] === 'undefined') {
                return false;
            }
        ...
        function datePickHandler() {
            ...
            var input = $(container).data('picker');
        ...
        function monthDayYearText() {
            ...
            $(dates).each(function (index, date) {
                ...
                var monthFullName = getMonthFullName(monthName);

                // AT Reads: {month} {date} {year} {day}
                // "December 18 2014 Thursday"
                var dateText = date.innerHTML + ' ' + monthFullName + ' ' + year + ' ' + daySpan.title;
        ...
        function appendOffscreenMonthText(button) {
            ...
            buttonText = (isNext)
                ? 'Next Month, ' + firstToCap(months_full[adjacentIndex]) + ' ' + currentYear
                : 'Previous Month, ' + firstToCap(months_full[adjacentIndex]) + ' ' + currentYear;
