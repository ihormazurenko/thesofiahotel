            ...
            <div class="tabs-box">
                <div class="tabs-content tabs-on">
                    <div class="tabs-nav">
                        <ul class="tab-list">
                            <li>
                                <a href="#hotel" title="Hotel" class="color-light-blue  hotel">Hotel</a>
                            </li>
                            <li>
                                <a href="#rooms" title="Rooms" class="color-gold  rooms">Rooms</a>
                            </li>
                            <li>
                                <a href="#restaurant" title="Restaurant" class="color-purple  restaurant">Restaurant</a>
                            </li>
                            <li>
                                <a href="#business" title="Business" class="color-grey  business">Business</a>
                            </li>
                            <li>
                                <a href="#area" title="Area" class="color-dark  area">Area</a>
                            </li>
                        </ul>
                    </div>

                    <div class="tab-box-btn">
                        <a href="#hotel" class="color-light-blue hotel" title="Hotel">Hotel</a>
                    </div>
                    ...
                    <div class="tab-box-btn">
                        <a href="#rooms" class="color-gold rooms" title="Rooms">Rooms</a>
                    </div>
                    ...
                    <div class="tab-box-btn">
                        <a href="#restaurant" class="color-purple restaurant" title="Restaurant">Restaurant</a>
                    </div>
                    ...
                    <div class="tab-box-btn">
                        <a href="#business" class="color-grey business" title="Business">Business</a>
                    </div>
                    ...
                    <div class="tab-box-btn">
                        <a href="#area" class="color-dark area" title="Area">Area</a>
                    </div>
